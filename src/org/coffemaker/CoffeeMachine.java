...
//    }
    //coffee machine is set with the ingredients, drinks and stock
    public CoffeeMachine(List<Ingredient> ingredients,Map<Ingredient, Integer> ingredientStock,List<Drink> drinks) {
    	this.ingredients.addAll(ingredients);
    	this.ingredientStock.putAll(ingredientStock);
    	this.drinks.addAll(drinks);
    }
...
//can get the ingredients, drinks, ingredient stock in CoffeeMachineDisplay
