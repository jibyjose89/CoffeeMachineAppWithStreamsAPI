...
public class CoffeeMachineDisplay {
    ...
    //sort the ingredients and drinks
    public CoffeeMachineDisplay(final CoffeeMachine coffeeMachine) {
        this.coffeeMachine = Objects.requireNonNull(coffeeMachine, "coffeeMachine must not be null");
    ...
    //get ingredient stock from coffee machine
